...
Feature:Main Page Modules and their functionality
  ...
  Scenario:007_navigation to Dashboard Module
  ...
  Scenario:008_navigation to Employee_Master_data module
  ...
  Scenario:009_navigation to Employee_Attendance module
  ...
  Scenario:010_navigation to Payroll module
  ...
  Scenario:011_navigation to Vehicles module
  ...
  Scenario:012_navigation to Admin_Users module
  ...
  Scenario:013_navigation to Admin_Options module
  ...
  Scenario:014_navigation to Admin_Holidays module
      And verify Admin Module Button is visible and is clickable
    Then click the Admin Module
  ...
  Scenario:015_navigation to Admin_Payout_amounts module
      And verify Admin Module Button is visible and is clickable
    Then click the Admin Module
  ...
  Scenario:016_navigation to Quickly_Gmbh module
  ...
  Scenario:017_navigation to Kinesis GPS module
